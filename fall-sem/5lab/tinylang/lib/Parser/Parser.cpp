...
namespace {
OperatorInfo fromTok(Token Tok) { return OperatorInfo(Tok.getLocation(), Tok.getKind()); }
} // namespace
...
bool Parser::parseImport() {
  auto _errorhandler = [this] { return skipUntil(tok::kw_BEGIN, tok::kw_CONST, tok::kw_END, tok::kw_FROM, tok::kw_IMPORT, tok::kw_PROCEDURE, tok::kw_TYPE, tok::kw_VAR); };
  IdentList Ids;
...
bool Parser::parseDeclaration(DeclList &Decls) {
  auto _errorhandler = [this] { return skipUntil(tok::kw_BEGIN, tok::kw_CONST, tok::kw_END, tok::kw_PROCEDURE, tok::kw_TYPE, tok::kw_VAR); };
...
bool Parser::parseExpression(Expr *&E) {
  auto _errorhandler = [this] { return skipUntil(tok::r_paren, tok::comma, tok::semi, tok::kw_DO, tok::kw_ELSE, tok::kw_END, tok::kw_THEN, tok::r_square); };
...
bool Parser::parseRelation(OperatorInfo &Op) {
  auto _errorhandler = [this] { return skipUntil(tok::l_paren, tok::plus, tok::minus, tok::kw_NOT, tok::identifier, tok::integer_literal); };
  if (Tok.is(tok::equal)) {
    Op = fromTok(Tok);
    advance();
...
bool Parser::parseSimpleExpression(Expr *&E) {
  auto _errorhandler = [this] { return skipUntil(tok::hash, tok::r_paren, tok::comma, tok::semi, tok::less, tok::lessequal, tok::equal, tok::greater, tok::greaterequal, tok::kw_DO, tok::kw_ELSE, tok::kw_END, tok::kw_THEN, tok::r_square); };
...
bool Parser::parseAddOperator(OperatorInfo &Op) {
  auto _errorhandler = [this] { return skipUntil(tok::l_paren, tok::kw_NOT, tok::identifier, tok::integer_literal); };
  if (Tok.is(tok::plus)) {
    Op = fromTok(Tok);
    advance();
  } else if (Tok.is(tok::minus)) {
...
bool Parser::parseTerm(Expr *&E) {
  auto _errorhandler = [this] {
    return skipUntil(tok::hash, tok::r_paren, tok::plus, tok::comma, tok::minus, tok::semi, tok::less, tok::lessequal, tok::equal, tok::greater, tok::greaterequal, tok::kw_DO, tok::kw_ELSE, tok::kw_END, tok::kw_OR, tok::kw_THEN,
                     tok::r_square);
  };
  if (parseFactor(E))
    return _errorhandler();
...
bool Parser::parseFactor(Expr *&E) {
  auto _errorhandler = [this] {
    return skipUntil(tok::hash, tok::r_paren, tok::star, tok::plus, tok::comma, tok::minus, tok::slash, tok::semi, tok::less, tok::lessequal, tok::equal, tok::greater, tok::greaterequal, tok::kw_AND, tok::kw_DIV, tok::kw_DO, tok::kw_ELSE,
                     tok::kw_END, tok::kw_MOD, tok::kw_OR, tok::kw_THEN, tok::r_square);
  };
...
bool Parser::parseSelectors(Expr *&E) {
  auto _errorhandler = [this] {
    return skipUntil(tok::hash, tok::r_paren, tok::star, tok::plus, tok::comma, tok::minus, tok::slash, tok::colonequal, tok::semi, tok::less, tok::lessequal, tok::equal, tok::greater, tok::greaterequal, tok::kw_AND, tok::kw_DIV,
                     tok::kw_DO, tok::kw_ELSE, tok::kw_END, tok::kw_MOD, tok::kw_OR, tok::kw_THEN, tok::r_square);
  };
...
bool Parser::parseQualident(Decl *&D) {
  auto _errorhandler = [this] {
    return skipUntil(tok::hash, tok::l_paren, tok::r_paren, tok::star, tok::plus, tok::comma, tok::minus, tok::period, tok::slash, tok::colonequal, tok::semi, tok::less, tok::lessequal, tok::equal, tok::greater, tok::greaterequal,
                     tok::kw_AND, tok::kw_DIV, tok::kw_DO, tok::kw_ELSE, tok::kw_END, tok::kw_MOD, tok::kw_OR, tok::kw_THEN, tok::l_square, tok::r_square, tok::caret);
  };
  D = nullptr;
  if (expect(tok::identifier))
    return _errorhandler();
