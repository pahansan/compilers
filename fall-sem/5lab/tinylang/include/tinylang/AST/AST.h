...
public:
  Field(SMLoc Loc, const StringRef &Name, TypeDeclaration *Type) : Loc(Loc), Name(Name), Type(Type) {}
...
class Decl {
public:
  enum DeclKind { DK_Module, DK_Const, DK_AliasType, DK_ArrayType, DK_PervasiveType, DK_PointerType, DK_RecordType, DK_Var, DK_Param, DK_Proc };
...
public:
  Decl(DeclKind Kind, Decl *EnclosingDecL, SMLoc Loc, StringRef Name) : Kind(Kind), EnclosingDecL(EnclosingDecL), Loc(Loc), Name(Name) {}
...
public:
  ModuleDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name) : Decl(DK_Module, EnclosingDecL, Loc, Name) {}

  ModuleDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name, DeclList &Decls, StmtList &Stmts) : Decl(DK_Module, EnclosingDecL, Loc, Name), Decls(Decls), Stmts(Stmts) {}
...
public:
  ConstantDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name, Expr *E) : Decl(DK_Const, EnclosingDecL, Loc, Name), E(E) {}
...
protected:
  TypeDeclaration(DeclKind Kind, Decl *EnclosingDecL, SMLoc Loc, StringRef Name) : Decl(Kind, EnclosingDecL, Loc, Name) {}

public:
  static bool classof(const Decl *D) { return D->getKind() >= DK_AliasType && D->getKind() <= DK_RecordType; }
};
...
public:
  AliasTypeDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name, TypeDeclaration *Type) : TypeDeclaration(DK_AliasType, EnclosingDecL, Loc, Name), Type(Type) {}
...
public:
  ArrayTypeDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name, Expr *Nums, TypeDeclaration *Type) : TypeDeclaration(DK_ArrayType, EnclosingDecL, Loc, Name), Nums(Nums), Type(Type) {}
...
public:
  PervasiveTypeDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name) : TypeDeclaration(DK_PervasiveType, EnclosingDecL, Loc, Name) {}

  static bool classof(const Decl *D) { return D->getKind() == DK_PervasiveType; }
};
...
public:
  PointerTypeDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name, TypeDeclaration *Type) : TypeDeclaration(DK_PointerType, EnclosingDecL, Loc, Name), Type(Type) {}
...
public:
  RecordTypeDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name, const FieldList &Fields) : TypeDeclaration(DK_RecordType, EnclosingDecL, Loc, Name), Fields(Fields) {}
...
public:
  VariableDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name, TypeDeclaration *Ty) : Decl(DK_Var, EnclosingDecL, Loc, Name), Ty(Ty) {}
...
public:
  FormalParameterDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name, TypeDeclaration *Ty, bool IsVar) : Decl(DK_Param, EnclosingDecL, Loc, Name), Ty(Ty), IsVar(IsVar) {}
...
public:
  ProcedureDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name) : Decl(DK_Proc, EnclosingDecL, Loc, Name) {}

  ProcedureDeclaration(Decl *EnclosingDecL, SMLoc Loc, StringRef Name, FormalParamList &Params, TypeDeclaration *RetType, DeclList &Decls, StmtList &Stmts)
...
public:
  InfixExpression(Expr *Left, Expr *Right, OperatorInfo Op, TypeDeclaration *Ty, bool IsConst) : Expr(EK_Infix, Ty, IsConst), Left(Left), Right(Right), Op(Op) {}
...
public:
  PrefixExpression(Expr *E, OperatorInfo Op, TypeDeclaration *Ty, bool IsConst) : Expr(EK_Prefix, Ty, IsConst), E(E), Op(Op) {}
...
public:
  IntegerLiteral(SMLoc Loc, const llvm::APSInt &Value, TypeDeclaration *Ty) : Expr(EK_Int, Ty, true), Loc(Loc), Value(Value) {}
...
public:
  IndexSelector(Expr *Index, TypeDeclaration *Type) : Selector(SK_Index, Type), Index(Index) {}
...
public:
  FieldSelector(uint32_t Index, StringRef Name, TypeDeclaration *Type) : Selector(SK_Field, Type), Index(Index), Name(Name) {}
...
public:
  Designator(VariableDeclaration *Var) : Expr(EK_Designator, Var->getType(), false), Var(Var) {}
  Designator(FormalParameterDeclaration *Param) : Expr(EK_Designator, Param->getType(), false), Var(Param) {}
...
public:
  FunctionCallExpr(ProcedureDeclaration *Proc, ExprList Params) : Expr(EK_Func, Proc->getRetType(), false), Proc(Proc), Params(Params) {}
...
public:
  AssignmentStatement(Designator *Var, Expr *E) : Stmt(SK_Assign), Var(Var), E(E) {}
...
public:
  IfStatement(Expr *Cond, StmtList &IfStmts, StmtList &ElseStmts) : Stmt(SK_If), Cond(Cond), IfStmts(IfStmts), ElseStmts(ElseStmts) {}
